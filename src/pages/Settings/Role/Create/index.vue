    ...
    <wrapper title="新建角色">
        ...
        >
            ...
            <a-form-item :wrapperCol="{ span: 14, offset: 6 }">
                ...
                <custom-button type="primary" size="large" ghost>重置</custom-button>
            </a-form-item>
        </a-form>
    </wrapper>
</template>
    ...
    setup() {
        ...
        const onSubmit = () => {
            if (!state.loading) {
                ...
                state.loading = true;
                // 网络请求
                RoleServerAPis.create(Object.assign({}, state.formState)).then((res: any) => {
                    ...
                    $message.error(`未知系统参数: ${err.message}`);
                }).finally(() => {
                    state.loading = false;
                })
            }
